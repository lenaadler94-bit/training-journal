...
### Агент записывает тренировку

![Агент записывает 1](images/Агент%20записывает%201.png)

![Агент записывает 2](images/Агент%20записывает%202.png)

### Агент и субагент делают отчёт

![Агент и Субагент делают отчет](images/Агент%20и%20Субагент%20делают%20отчет.png)

### Агент корректирует запись тренировки

![Агент кореектирует запись тренировки](images/Агент%20кореектирует%20запись%20тренировки.png)

### Результат в журнале

![Результат в журнале — тренировка](images/Результат%20в%20журнале%20тренировка.png)

![Результат в журнале — отчёт](images/Результат%20в%20журнале%20отчет.png)
